...
export declare namespace RequestTypes {
  ...
  type BulkOverwriteApplicationGuildCommandsPermissions =
    Array<BulkOverwriteApplicationGuildCommandsPermission>;
  ...
  interface CreateApplicationCommand {
    ...
    name: string;
    options?: Array<
      CreateApplicationCommandOption | toJSON<CreateApplicationCommandData>
    >;
    type?: number;
  }
  ...
  interface CreateApplicationCommandOption {
    ...
    name: string;
    options?: Array<
      CreateApplicationCommandOption | toJSON<CreateApplicationCommandOption>
    >;
    required?: boolean;
    type: number;
  }
  interface CreateApplicationGuildCommand extends CreateApplicationCommand {}
  interface CreateApplicationGuildCommandData
    extends CreateApplicationCommandData {}
  ...
  interface CreateChannelMessageComponent {
    components?: Array<
      CreateChannelMessageComponent | toJSON<RawChannelMessageComponent>
    >;
    customId?: string;
    disabled?: boolean;
  ...
  interface CreateInteractionResponseInnerPayload {
    ...
    components?:
      | Array<
          CreateChannelMessageComponent | toJSON<RawChannelMessageComponent>
        >
      | toJSON<Array<RawChannelMessageComponent>>;
    content?: string;
    embed?:
      | CreateChannelMessageEmbed
      | toJSON<CreateChannelMessageEmbed>
      | null;
    embeds?: Array<
      CreateChannelMessageEmbed | toJSON<CreateChannelMessageEmbed>
    >;
    file?: File;
    files?: Array<File>;
    flags?: number;
  ...
  interface CreateInteractionResponseData {
    data?: {
      ...
      components?:
        | Array<RawChannelMessageComponent | toJSON<RawChannelMessageComponent>>
        | toJSON<Array<RawChannelMessageComponent>>;
      content?: string;
  ...
  interface RawChannelMessageComponent {
    components?: Array<
      RawChannelMessageComponent | toJSON<RawChannelMessageComponent>
    >;
    custom_id?: string;
    disabled?: boolean;
    emoji?: RawEmojiPartial;
